	  ...
	  <div id="lm_info"><span>当前位置：监区设置</span></div>
	       <form action="jqSet.do?method=search" method="post">
			     	<table style="border-style:solid; border-color:#76a5af; border-width:1px 0 0 1px; width:60%; margin:0 auto; margin-top:10px;">
			     		...
			     		<tr>
			     			<td>监区名称：</td>
			     			<td><input type="text" id="jqName" name="jqName" value="${jlJq.jqName}" disabled="disabled" /></td>
			     		</tr>
			     		<tr>
			     			<td>服务器名称：</td>
			     			<td><input type="text" id="jy" name="jy" value="${jlJq.jy}" disabled="disabled" /></td>
			     		</tr>
			     		<tr>
			     			<td>星期：</td>
			     		...
			     		<tr>
			     			<td><a href="javascript:void(0);" onclick="addSaveJqWeek();return false;"><img src="<%=basePath %>images/baocun.gif"></img></a><input type="hidden" id="webId" value="${jlJq.webId}" /></td>
