	  ...
	  <div id="lm_info"><span>当前位置：监区设置</span></div>
	       <form action="jqSet.do?method=search" method="post">
			     	<table style="border-style:solid; border-color:#76a5af; border-width:1px 0 0 1px; width:60%; margin:0 auto; margin-top:10px;">
			     		<tr>
			     			<td width="30%">监区编号：</td>
			     			<td width="30%"><input type="text" id="jqNo" name="jqNo" /></td>
			     		</tr>
			     		<tr>
			     			<td>监区名称：</td>
			     			<td><input type="text" id="jqName" name="jqName" /></td>
			     		</tr>
			     		<tr>
			     			<td>服务器名称：</td>
			     			<td><select id="jyId" style="width:130px;">
			     		...
			     		<tr>
			     			<td>特殊监区：</td>
			     			<td><input type="radio" name="isTs" value="0" checked="checked" />不是 <input type="radio" name="isTs" value="1" />是</td>
			     		</tr>
			     		<tr>
			     			<td><a href="javascript:void(0);" onclick="addSaveJq();return false;"><img src="images/baocun.gif"></img></a></td>
