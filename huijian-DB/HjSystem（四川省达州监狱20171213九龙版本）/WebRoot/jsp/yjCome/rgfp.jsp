...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="openPort();" onunload="colsePort();">
		...
		<form action="yjCome.do?method=search2" method="post">
	 	 	 <table style="border-style:solid; border-color:#76a5af; border-width:1px 0 0 1px; width:85%; margin:0 auto; margin-top:10px;">
					<!--  
					<tr>
						<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;警察卡号：<input type="text" id="yjCardNo" disabled="disabled"/><input type="button" value="读卡" onclick="readCard()"/></td>
					</tr>-->
					<tr>
						<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;犯人姓名：<input type="text"  value="${jlHjDj.frName }" disabled="disabled"/></td>
					</tr>
					<tr>
						<td colspan="2">服务器名称：<select id="jy" style="width:130px" onchange="checkLine();">
														<option value="null">全部</option>
														<logic:iterate id="fwq" name="sysQqServerList">
															<option value="${fwq.serverName}">${fwq.serverName}</option>
														</logic:iterate>
													</select>
						</td>
					</tr>
					...
					<tr>
						<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;警察卡号：<input type="text" id="yjCardNo" disabled="disabled" value="${jlYj.yjCard }"/></td>
					</tr>
					<tr>
						<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;警察警号：<input type="text" id="yjNum" value="${jlYj.yjNum }"//><font color="red">☆温馨提示：选择座位，输入警号，点击保存分配座位！</font></td>
					</tr>
					<tr>
						<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;警察姓名：<input type="text" id="yjName" value="${jlYj.yjName }"/></td>
					</tr>
					<tr>
		      	 		<td><a href="javascript:void(0);" onclick="rgfpZw();return false;"><img src="images/baocun.gif"></img></a><input type="hidden" id="hjid" name="hjid" value="${jlHjDj.hjid }" /><input type="hidden" id="hjType" name="hjType" value="${jlHjDj.hjType}" /></td>
