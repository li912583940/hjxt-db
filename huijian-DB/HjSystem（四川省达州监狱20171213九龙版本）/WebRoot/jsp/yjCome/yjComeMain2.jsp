...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onkeydown="return enterSubmit(this,event);">
		...
		<div id="lm_info2"><span>当前位置：警察签到 </span></div>
	 	 	...
	 	 	<div id="content2">
	 	 			<table>
	 	 				<tr>
	 	 					...
	 	 					<td colspan="3" nowrap="nowrap">监区：<html:select property="jq" style="width:130px">
	 	 													...
	 	 													</html:select>&nbsp;&nbsp;<input type="button" value="查       询"  onclick="yjComeSearch();"/>&nbsp;&nbsp;<input type="button" value="批量签到" onclick="plQd();"/></td>
	 	 				</tr>
						<tr>
					...
					<logic:notEmpty name="list1">
						<logic:iterate id="jl" name="list1" indexId="index">
							<tr onmouseover= "this.style.background ='#FFFFFF';" onmouseout="this.style.background ='#DDF2FF';">
								<td nowrap="nowrap"><a href="javascript:void(0)" onclick="yjcome();return false;">警察签到</a>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="delQd();return false;">取消签到</a>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="rgfp();return false;">人工分配</a><input type="hidden" name="hjid" value="${jl.hjid}"/></td>
								...
								<td nowrap="nowrap">
									<c:if test="${jl.hjType==1}">严见</c:if>
									<c:if test="${jl.hjType==2}"><font color="red">宽见</font></c:if>
								</td>
