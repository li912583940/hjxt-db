  ...
  <head>
   ...
   <body>
    ...
    <form action="materialMessage.do?method=checkTpDh&frNo=${frNo}" method="post">
      	 <table style="border-style:solid; border-color:#e6e6e6; border-width:1px 0 0 1px; width:30%; margin:0 auto; margin-top:10px;">
      	 	<tr>
      	 		<td><font color="red">删除成功</font></td>
      	 	</tr>
      	 	<tr>
      	 		<td><a href="materialMessage.do?method=checkTpDh&frNo=${frNo}"><img src="images/fanhui.gif"></img></a></td>
      	 	</tr>
      	 </table>
      	 </form>
  </body>
