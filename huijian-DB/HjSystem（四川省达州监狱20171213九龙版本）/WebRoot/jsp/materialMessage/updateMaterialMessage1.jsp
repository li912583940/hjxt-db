   ...
   <body>
    ...
    <form action="materialMessage.do?method=search" method="post">
		      	 <table style="border-style:solid; border-color:#76a5af; border-width:1px 0 0 1px; width:60%; margin:0 auto; margin-top:10px;">
		      	 	...
		      	 	<tr>
		      	 		<td>会见剩余次数：</td>
		      	 		<td><input type="text" id="hjleft" name="hjleft" value="${jlFr.hjLeft}" disabled="disabled" /></td>
		      	 	</tr>
		      	 	<tr>
		      	 		<td>服务器名称：</td>
		      	 		<td>
				      	 		<select id="jy1" style="width:130px" onchange="checkJq1();" disabled="disabled">
		      	 	...
		      	 	<tr>
		      	 		<td>分管等级：</td>
		      	 		<td>
		      	 			<select id="jb1" style="width:130px" disabled="disabled">
		      	 	...
		      	 	<tr>
		      	 		<td>会见级别：</td>
		      	 		<td>
		      	 			<select id="hjJb" style="width:130px" onchange="hjST();" disabled="disabled">
		      	 	...
		      	 	<tr>
		      	 		<td>国籍：</td>
		      	 		<td><input type="text" id="frGj" name="frGj" value="${jlFr.frGj}" disabled="disabled" /></td>
		      	 	</tr>
		      	 	<tr>
		      	 		<td>入监时间：</td>
		      	 		<td><input type="text" id="infoRjsj" name="infoRjsj" value="${jlFr.infoRjsj}" disabled="disabled" /></td>
		      	 	</tr>
		      	 	<tr>
		      	 		<td>罪名：</td>
		      	 		<td><input type="text" id="infoZm" name="infoZm" value="${jlFr.infoZm}" disabled="disabled" /></td>
		      	 	</tr>
		      	 	<tr>
		      	 		<td>刑期：</td>
		      	 		<td><input type="text" id="infoXq" name="infoXq"  value="${jlFr.infoXq}" disabled="disabled" /></td>
		      	 	</tr>
		      	 	<tr>
		      	 		<td>出生日期：</td>
		      	 		<td><input type="text" id="infoCsrq" name="infoCsrq"  value="${jlFr.infoCsrq}" disabled="disabled" /></td>
		      	 	</tr>
		      	 	<tr>
		      	 		<td>住址：</td>
		      	 		<td><input type="text" id="infoHome" name="infoHome" value="${jlFr.infoHome}" disabled="disabled" /></td>
		      	 	</tr>
		      	 	<tr>
		      	 		<td>是否重点监控：</td>
		      	 		<td>
		      	 			<select id="monitorFlag" style="width:130px" disabled="disabled">
		      	 	...
		      	 	<tr>
		      	 		...
		      	 		<td>
		      	 			...
		      	 			<select id="stateZdzf" style="width:130px" disabled="disabled">
		      	 	...
		      	 	<tr>
		      	 		...
		      	 		<input  id="zdzfType"   value="${jlFr.zdzfType }" disabled="disabled" />

		      	 		</td>
		      	 	</tr>
		      	 	<tr>
		      	 		<td>罪犯状态：</td>
		      	 		<td><select id="state" onchange="setCysj();" style="width:130px" disabled="disabled">
		      	 	...
		      	 	<tr>
		      	 		...
		      	 		<td><a id="returnBack" href="materialMessage.do?method=search2&frNo3=${frNo3}&frName2=${frName2}&jy2=${jy2}&jq2=${jq2}&jbNo2=${jbNo2}&pageNo2=${pageNo2}&stateZdzf2=${stateZdzf2}&state2=${state2}&frCard2=${frCard2}"><img src="images/fanhui.gif"></img></a></td>
		      	 	</tr>
		      	 </table>
     </form>
