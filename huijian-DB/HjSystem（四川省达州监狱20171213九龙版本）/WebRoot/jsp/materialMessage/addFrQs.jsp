		...
		<script type="text/javascript" language="javascript" > 
			 document.onkeydown   =   function(){       
				...
				function swfLoadedHandler() {
					document.getElementById("camera").savefile("c:\\temp.jpg",100,126);
	   ...
	   <form action="materialMessage.do?method=checkQs&frNo=${jlFr.frNo}" method="post">
      	 <table style="border-style:solid; border-color:#76a5af; border-width:1px 0 0 1px; width:90%; margin:0 auto; margin-top:10px;font-size:15px;font-family:微软雅黑;">
      	 	...
      	 	<tr style="height:40px">
      	 		<td width="30%">证件号码：<input type="text" id="qsSfz" name="qsSfz" value="${qsSfz}" /></td>
      	 		<td width="30%"><input type="button" value="识别" onclick="shibie1();" />	<c:if test="${sysParam.paramData1==1}">	&nbsp;&nbsp;<input type="button" value="拍照" onclick="swfLoadedHandler();" /></c:if></td>
      	 	</tr>
      	 	<tr style="height:40px">
      	 		<td>亲属姓名：<input type="text" id="qsName" name="qsName" /></td>
      	 	...
      	 	<tr style="height:40px">
      	 		<td><a href="javascript:void(0);" onclick="addSaveQs();return false;"><img src="images/baocun.gif"></img></a></td>
