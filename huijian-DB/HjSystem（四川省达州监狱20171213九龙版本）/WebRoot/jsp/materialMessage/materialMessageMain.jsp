		     	...
		     	<table  border="0" cellspacing="0" cellpadding="0">
		     		...
		     		<tr>
						...
						<html:select property="stateZdzf" styleId="stateZdzf" style="width:130px">
		     			...
		     			<a href="javascript:void(0)" onclick="checkFr();return false;"><img src="images/chaxun.gif"></img></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="addFr();return false;"><img src="images/zengjia.gif"></img></a></td>
		     		</tr>
		     		<tr>
		     		  ...
		     		  <logic:notEmpty name="page" property="list">
		     				...
		     				<tr onmouseover= "this.style.background ='#FFC1C1';" onmouseout="this.style.background ='#FFFFFF';">
		     					...
		     					<td height="25px" nowrap="nowrap"><a href="javascript:void(0)" onclick="updateFr();return false;">修改</a>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="delFr();return false;">删除</a><input type="hidden" id="webId" name="webId" value="${fr.webId}" /><input type="hidden" id="frNo2" name="frNo2" value="${fr.frNo}" /></td>
		     					<td height="25px" nowrap="nowrap"><a href="javascript:void(0)" onclick="checkQs();return false;">亲属</a></td>
		     				</tr>
		     				</logic:iterate>
		     				<tr>
		     					<td colspan="11" height="25px"><page:page pageNo="${page.pageNo}" pageSize="${page.pageSize}" recordCount="${page.recordCount}" url="materialMessage.do?method=search1"></page:page><input type="hidden" id="isDc" name="isDc" value="1"/></td>
		     				</tr>
		     		</logic:notEmpty>
