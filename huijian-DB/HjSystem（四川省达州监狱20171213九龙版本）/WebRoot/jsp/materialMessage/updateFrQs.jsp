...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <!-- <body> -->
    ...
    <form action="materialMessage.do?method=checkQs&frNo=${jlFr.frNo}" method="post">
      	 <table style="border-style:solid; border-color:#76a5af; border-width:1px 0 0 1px; width:95%; margin:0 auto; margin-top:10px;font-size:15px;font-family:微软雅黑;">
      	 	<tr>
      	 		<td width="25%" nowrap="nowrap">罪犯编号：<input type="text" id="frNo1" name="frNo1" value="${jlFr.frNo }" disabled="disabled" /></td>
      	 		<td width="70%" rowspan="3" nowrap="nowrap">
      	 			...
      	 			<logic:notEmpty name="jlQs" property="zp">
      	 				<img id="photo" src="materialMessage.do?method=showPhoto&qsid=${jlQs.webId}" />
      	 				<object width="0px" height="0px" id="IDCard2" name="IDCard2"  codebase="<%=basePath %>ocx/SynCardOcx.CAB#version=1,0,0,1" classid="clsid:4B3CB088-9A00-4D24-87AA-F65C58531039">
					</object>		
					<img id="sfzz" src="<%=basePath %>images/zpbj.jpg" width="150px" height="176px"></img>
      	 			</logic:notEmpty>
      	 			<c:if test="${sysParam.paramData1==1}">
	      	 			...
	      	 			<logic:notEmpty name="jlQs" property="jz">
	      	 				<img id="photo" src="materialMessage.do?method=showPhotoJZ&qsid=${jlQs.webId}" style="width:165px;height:176px"/>
	      	 				<object id="camera" classid="clsid:792FD9B8-5917-45D2-889D-C49FD174D4E0"
								  codebase="<%=basePath %>ocx/capProj1.ocx#version=1,0,0,0"
								  width=160
								  height=176
      	 	...
      	 	<tr>
      	 		<td nowrap="nowrap">罪犯姓名：<input type="text" id="frName1" name="frName1" value="${jlFr.frName}" disabled="disabled" /></td>
      	 	</tr>
      	 	<tr>
      	 		<td nowrap="nowrap">证件类别：<select id="zjlb" style="width:130px;">
      	 	...
      	 	<tr style="height:40px">
      	 		<td nowrap="nowrap">证件号码：<input type="text" id="qsSfz" name="qsSfz" value="${jlQs.qsSfz }"/></td>
      	 		<td nowrap="nowrap"><input type="button" style="color:red;" value="识别身份证" onclick="updateshibie();" /><c:if test="${sysParam.paramData1==1}">	&nbsp;&nbsp;<input type="button" style="color:red;" value="拍照" onclick="swfLoadedHandler();" /></c:if></td>
      	 	</tr>
      	 	<tr style="height:40px">
      	 		<td>亲属姓名：<input type="text" id="qsName" name="qsName" value="${jlQs.qsName }" /></td>
      	 	...
      	 	<c:if test="${sysUser.isSp==0}">
      	 		...
      	 		<td>
      	 			禁止会见时间：<input type="text" id="hjStopTime" name="hjStopTime" value="${jlQs.hjStopTime }"  onfocus="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})"/>&nbsp;&nbsp;&nbsp;&nbsp;备注：<input type="text" id="bz" name="bz" value="${jlQs.bz}" />
      	 		</td>
      	 	</tr>
      	 	<tr style="height:40px">
      	 		<td><a href="javascript:void(0);" onclick="updateSaveFrQs();return false;"><img src="images/baocun.gif"></img></a><input type="hidden" id="qsId" name="qsId" value="${jlQs.webId}" /></td>
      	 		<td><a id="returnBack" href="materialMessage.do?method=checkQs&frNo=${jlFr.frNo}&frNo3=${frNo3}&frName2=${frName2}&jy2=${jy2}&jq2=${jq2}&jbNo2=${jbNo2}&pageNo2=${pageNo2}&stateZdzf2=${stateZdzf2}&state2=${state2}&frCard2=${frCard2}"><img src="images/fanhui.gif"></img></a></td>
      	 	</tr>
      	 </table>
      	 </form>
