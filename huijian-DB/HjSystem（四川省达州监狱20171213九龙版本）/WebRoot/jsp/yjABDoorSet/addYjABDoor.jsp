	  ...
	  <div id="lm_info"><span>当前位置：陪同警察管理</span></div>
	       <form action="yjABDoorMessage.do?method=search" method="post">
			     	<table style="border-style:solid; border-color:#76a5af; border-width:1px 0 0 1px; width:60%; margin:0 auto; margin-top:10px;">
			     		<tr>
			     			<td width="30%">警号：</td>
			     			<td width="30%"><input type="text" id="yjNo" name="yjNo" /></td>
			     		</tr>
			     		<tr>
			     			<td>姓名：</td>
			     			<td><input type="text" id="yjName" name="yjName" /></td>
			     		</tr>
			     		<tr>
			     			<td><a href="javascript:void(0);" onclick="addSaveYjABDoor();return false;"><img src="images/baocun.gif"></img></a></td>
