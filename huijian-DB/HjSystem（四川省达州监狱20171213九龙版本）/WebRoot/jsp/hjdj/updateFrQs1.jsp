...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <!--  <body>-->
    ...
    <form action="hjdj.do?method=checkFr&frNo=${jlFr.frNo}" method="post">
      	 <table style="border-style:solid; border-color:#76a5af; border-width:1px 0 0 1px; width:95%; margin:0 auto; margin-top:10px;font-size:15px;font-family:微软雅黑;">
      	 	...
      	 	<tr style="height:40px">
      	 		<td>亲属姓名：<input type="text" id="qsName" name="qsName" value="${jlQs.qsName }" /> <!--  <input type="radio" name="cardType" value="0" checked="checked"/>旧卡<input type="radio" name="cardType" value="1"/>新卡-->
      	 	...
      	 	<tr style="height:40px">
      	 		<td><a href="javascript:void(0);" onclick="updateSaveFrQs1();return false;"><img src="images/baocun.gif"></img></a><input type="hidden" id="qsId" name="qsId" value="${jlQs.webId}" /><input type="hidden" id="jqNo1" name="jqNo1" value="${jlFr.jq }"/></td>
      	 		<td><a href="hjdj.do?method=checkFr&frNo=${jlFr.frNo}"><img src="images/fanhui.gif"></img></a></td>
      	 	</tr>
