...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<html:form action="cancelDj.do?method=search4" method="post">
	 	 	<div id="content2">
	 	 			<table>
	 	 				<tr>
	 	 					<td colspan="3" width="24%" nowrap="nowrap">开始时间：<html:text  property="beginTime"  styleId="callTimeStart" value="${todayBegin}" onfocus="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})"></html:text></td>
	 	 					<td colspan="3" width="24%" nowrap="nowrap">结束时间：<html:text  property="endTime"    styleId="callTimeEnd" value="${todayEnd}" onfocus="WdatePicker({startDate:'%y-%M-01 23:59:59',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" ></html:text></td>
	 	 					<td colspan="3" width="24%" nowrap="nowrap">会见状态：<html:select property="state" style="width:130px">
	 	 				...
	 	 				<tr>
	 	 					<td colspan="3" width="24%" nowrap="nowrap">罪犯编号：<html:text  property="frNo"  styleId="frNo" ></html:text></td>
	 	 					<td colspan="3" width="24%" nowrap="nowrap">罪犯姓名：<html:text  property="frName"  styleId="frName"></html:text></td>
	 	 					<td colspan="3" width="24%" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;监区：<html:select property="jq" style="width:130px">
	 	 													<html:option value="null">全部</html:option>
	 	 					...
	 	 					<td colspan="3" width="24%" nowrap="nowrap"><html:button value="查询" property="cx" onclick="checkDj1();"/></td>
	 	 				</tr>
						<tr>
							<th width="8%" nowrap="nowrap">监区</th>
							<th width="8%" nowrap="nowrap">罪犯编号</th>
							<th width="8%" nowrap="nowrap">会见编号</th>
							<th width="8%" nowrap="nowrap">学员姓名</th>
							<th width="25%" nowrap="nowrap">亲属</th>
							<th width="4%" nowrap="nowrap">物品</th>
							<th width="5%" nowrap="nowrap">会见时长</th>
							<th width="5%" nowrap="nowrap">会见类型</th>
							<th width="14%" nowrap="nowrap">会见说明</th>
							<th width="8%" nowrap="nowrap">登记时间</th>
							<th width="5%" nowrap="nowrap">登记人</th>
					...
					<logic:notEmpty name="page" property="list">
						...
						<tr>
							<td colspan="12">
								<div id="info2"><page:page pageNo="${page.pageNo}" recordCount="${page.recordCount}" url="cancelDj.do?method=search5" pageSize="${page.pageSize}"/><input type="hidden" id="isDc" name="isDc" value="1"/></div>
							</td>
						</tr>
					</logic:notEmpty>
					<logic:empty name="page" property="list">
							<tr><td colspan="13"><font color="red">没有相关信息</font><input type="hidden" id="isDc" name="isDc" value="0"/></td></tr>
					</logic:empty>
					</tbody>
			</table>
	 	 </div>
	 	 <div style="position:absolute;margin-top:18px;margin-left:30px;height:25px; line-height:25px;">
				   <input type="button" value="导出登记记录" onclick="dcCancelDjSearch();"/>
