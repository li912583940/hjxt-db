       ...
       <html:form action="hjRecord.do?method=search" method="post">
        	<div id="content2">
		     	...
		     	<tr>
		     	    ...
		     	    <th height="25px">复听时间</th>
		     	 </tr>
		     	    <logic:notEmpty name="jlHjRecAssessmentInfoList">
		     	       <logic:iterate id="jl" name="jlHjRecAssessmentInfoList">
			     	    	<tr>
		     	    ...
		     	    <logic:empty name="jlHjRecAssessmentInfoList">
			     	    	<tr>
