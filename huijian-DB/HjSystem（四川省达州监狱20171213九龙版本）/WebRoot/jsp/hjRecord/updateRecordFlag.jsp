   ...
   <body>
	...
	<div id="lm_info"><span>当前位置：会见通话记录 </span></div>
        	 <form action="user.do?method=search" method="post">
      		...
      		<tr>
               <td width="30%">呼叫ID：</td>
               <td width="30%"><input type="text" name="callId" id="callId" value="${jlQqInfo.callId}" disabled="disabled" /></td>        		
      		</tr>
      		<tr>
      		    <td>用户编号：</td>
                <td><input type="text" name="userNo" id="userNo" value="${jlQqInfo.userNo}" disabled="disabled" /></td>     		
      		</tr>
      		<tr>
                <td>监听注释：</td>
                <td><textarea name="jtwriteTxt" id="jtwriteTxt" style="width:130px" disabled="disabled">${jtwriteTxt}</textarea></td>       		
      		</tr>
      		<tr>
                <td>回放注释：</td>
                <td><textarea name="writeTxt" id="writeTxt" style="width:130px">${jlQqInfo.writeTxt}</textarea></td>       		
      		</tr>
      		<tr>
      			<td><a href="javascript:void(0);" onclick="updatesaveRecordFlag();return false;"><img src="images/baocun.gif"></img></a><input type="hidden" id="webId" name="webId" value="${jlQqInfo.webId}" /></td>
