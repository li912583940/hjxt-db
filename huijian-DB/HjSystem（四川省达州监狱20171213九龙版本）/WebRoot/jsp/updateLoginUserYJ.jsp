...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <body>
   	<div id="user_info"><span>登录姓名：${jlYj.yjName } 登录时间：${loginTime }</span></div>
	<div id="lm_info"><span>当前位置：修改密码 </span></div>
	     <form action="" method="post">
			   	<table style="border-style:solid; border-color:#76a5af; border-width:1px 0 0 1px; width:60%; margin:0 auto; margin-top:10px;">
			   		<tr>
			   			<td width="30%">用户名：</td>
			   			<td width="30%"><input type="text" id="username" name="username" value="${jlYj.teleUser }" disabled></td>
			   		</tr>
			   		<tr>
			   			<td>原始密码：</td>
			   		...
			   		<tr>
			   			<td><a href="javascript:void(0)" onclick="saveYj();return false;"><img src="<%=basePath%>images/baocun.gif"></img></a><input type="hidden" id="loginPassword" name="loginPassword" value="${jlYj.telePwd}"><input type="hidden" id="userId" name="userId" value="${jlYj.webId}"><input type="hidden" id="lujin" name="lujin" value="<%=basePath %>"></td>
