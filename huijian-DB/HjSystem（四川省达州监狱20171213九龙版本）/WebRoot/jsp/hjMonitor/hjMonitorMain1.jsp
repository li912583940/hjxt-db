...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
		...
		function jianting(){
			...
			//判断线路是否配置视频服务器，没有配置则只监听音频，配置了则弹出视频窗口
			var videoChan1Servers=document.getElementsByName("videoChan1Server");
			if(videoChan1Servers=='' || videoChan1Servers==null){
				 var lineNos = document.getElementsByName("lineNo");
			  	 var serverNames = document.getElementsByName("jy");
			  	 var zwNos = document.getElementsByName("zwNo");
			  	 var hjids = document.getElementsByName("hjid");
  ...
  <body onload="aa();" >
	  ...
	  <div id="lm_info5"><span>当前位置：普通实时监控</span></div>
	       <form action="" method="post">
	        	<div id="content5">
			     	...
			     	<tr>
			     	   ...
			     	   <th width="10%" nowrap="nowrap">会见人信息</th>
		 				...
		 				<tbody id="info5">
					     	   ...
					     	   <tr>
					     	       ...
					     	       <td width="14%" nowrap="nowrap"><span id="jt"><a href="javascript:void(0)" onclick="jianting();return false;">监听音视频</a></span>
					     	        -->
					     	       <!-- 点击没有效果的 -->
					     	       <td width="14%" nowrap="nowrap"><span id="jt"><a href="#">监听音视频</a></span>
					     	        							  ...
					     	        							  -->
					     	       								  <!-- 点击没有效果的 -->
					     	                                   	  <span id="jtyp"><a href="#">监听音频</a></span>
			     ...
			     <div id="info" style="position:absolute;margin-top:20px;margin-left:20px;height:25px; line-height:25px;"></div><span style="position:absolute;margin-top:20px;margin-left:130px;height:25px; line-height:25px;">座位：<input type="text" id="lineCh" disabled="disabled" size="10" /><input type="hidden" id="serverNameCh"/><input type="hidden" id="lineCh1"  /><input type="hidden" id="ingHjid"  /><input type="hidden" id="ingLineType"  /><input type="hidden" id="jttype" value="${sysParam.paramData2}"/>&nbsp;&nbsp;<select id="chId"><logic:iterate name="jlMonitorVocList" id="jl"><option value="${jl. vocId}">${jl. vocInfo}</option></logic:iterate></select>&nbsp;&nbsp;<input type="button" onclick="chahua();" value="插话" /></span><span id="info1" style="position:absolute;margin-top:20px;margin-left:670px;height:25px; line-height:25px;"></span>
		   		 ...
		   		 <div id="info4" style="position:absolute;margin-top:80px;margin-left:130px;height:25px; line-height:25px;"><font color="green"></font>&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">宽见</font>窗口使用情况：总数量&nbsp;&nbsp;<font color="red">8</font>&nbsp;&nbsp; 个，正在使用&nbsp;&nbsp;<font color="red">${hjm.threeKJshiyong }</font>&nbsp;&nbsp;个，未使用&nbsp;&nbsp;<font color="red">${hjm.threeKJweishiyong }</font>&nbsp;&nbsp;个，屏蔽&nbsp;&nbsp;<font color="red">${hjm.threeKJpingbi }</font>&nbsp;&nbsp;个；</div>
		   		  <div id="info6" style="position:absolute;margin-top:110px;margin-left:180px;height:25px; line-height:25px;"><font color="green">四楼</font>&nbsp;&nbsp;&nbsp;&nbsp;会见窗口使用情况：总数量&nbsp;&nbsp;<font color="red">27</font>&nbsp;&nbsp; 个，正在使用&nbsp;&nbsp;<font color="red">${hjm.fourShiyong }</font>&nbsp;&nbsp;个，未使用&nbsp;&nbsp;<font color="red">${hjm.fourWeishiyong }</font>&nbsp;&nbsp;个，屏蔽&nbsp;&nbsp;<font color="red">${hjm.fourPingbi }</font>&nbsp;&nbsp;个；</div> -->
