...
/**
 * JlFbFr entity. @author MyEclipse Persistence Tools
 */
...
public class JlFbFr implements java.io.Serializable {
	...
	/** minimal constructor */
	public JlFbFr(String frNo, String jy, String jq, String jbNo, Integer qqJb,
			Integer qqUse, Integer qqLeft, Integer hjJb, Integer hjUse,
			Integer hjLeft, String monitorFlag, Integer state, Integer spState) {
		this.frNo = frNo;
		this.jy = jy;
		this.jq = jq;
		this.jbNo = jbNo;
	...
	/** full constructor */
	public JlFbFr(String frNo, String frName, String frCard, String jy,
			...
			String infoZdzf, String infoHome,String formerJQName,String frDah,Integer stateZdzf,String zdzfType,String frGj, String infoCsrq) {
		this.frNo = frNo;
		this.frName = frName;
		this.frCard = frCard;
		this.jy = jy;
